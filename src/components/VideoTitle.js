...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="w-full md:w-screen aspect-video pt-[24%] px-6 md:px-12 absolute text-white bg-gradient-to-r from-black">
      <h1 className="text-3xl py-4 md:py-0 md:text-4xl font-bold">{title}</h1>
      <p className="py-4 md:py-6 text-base md:text-md lg:text-lg md:w-1/2 md:block hidden">{overview}</p>
      <div className="flex md:flex-row items-start md:items-center gap-4 md:gap-8">
